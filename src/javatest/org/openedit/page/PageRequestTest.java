...
public class PageRequestTest extends BaseTestCase
{
	...
	/*
	 * public void testOverrideDirectory() throws Exception { Page overridepage =
	 * getPage("/overrideme/apos.html"); overridepage = getPage("/overrideme/apos.html"); assertNotNull(
	 * overridepage.getLayout() ); assertEquals( "/overrideme/layout1.html", overridepage.getLayout());
	 * String content = overridepage.getContent(); assertEquals("<DIV>Real File</DIV>",content); }
	 */
