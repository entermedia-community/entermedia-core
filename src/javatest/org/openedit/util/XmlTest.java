...
public class XmlTest extends BaseTestCase
{
	...
	public void testXmlReader() throws Exception
	{
		...
		for (int i = 0; i < 10000; i++)
		{
			...
			// e.addElement("childContent").addElement("childA").addElement("childB").addElement("childC").addElement("childD").addAttribute("Dattrib",
			// "sdfsddsfdsfsdf");
		}
		...
		for (int i = 0; i < 100; i++)
		{
			...
			// getFixture().getPageManager().saveContent( junk,user,new
			// ElementReader(root,xml.getWriter("UTF-8")),null);
