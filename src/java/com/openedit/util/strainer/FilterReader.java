...
public class FilterReader
{
	 ...
	 * 		   <ul><li><code>null</code>  if the configuration is null or has no children;
	 * 		   <li>the corresponding filter, if the configuration has exactly one child; or
	 * 		   <li>an <code>AndFilter</code> containing all the children, if there is more than
	 * 		   one child.   </ul>
	 *
	...
	protected Filter readFilter(Configuration inConfig, String inPermission) throws OpenEditException
	{
		...
		else if (elemName.equals("page-property") || elemName.equals("pageproperty"))
		{
			result = new PagePropertyFilter(
					inConfig.getAttribute("name"), inConfig.getAttribute("equals"));
		}
		else if (elemName.equals("pagevalue") || elements.equals("context-variable"))
		{
