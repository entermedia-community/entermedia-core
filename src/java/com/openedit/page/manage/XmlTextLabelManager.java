...
public class XmlTextLabelManager
{
	...
	private static final Log log = LogFactory.getLog(XmlTextLabelManager.class);
	...
	{
		Boolean auto = (Boolean)getAutoTranslations().get(inFolder);
		if( auto == null)
		{
			...
			getAutoTranslations().put(inFolder,auto);
		}
