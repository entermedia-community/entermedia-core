 ...
 *
 */
public class FileGroupSearcher extends BaseSearcher implements UserSearcher
{
	private static final Log log = LogFactory.getLog(FileGroupSearcher.class);
	protected XmlUserArchive fieldXmlUserArchive;

	@Override
	public Data createNewData()
	{
		BaseGroup user = new BaseGroup();
		return user;
	}
	...
	public void saveUsers(List inUserstosave, User inUser)
	{
		...
		for (Iterator iterator = inUserstosave.iterator(); iterator.hasNext();)
		{
			...
			getXmlUserArchive().saveGroup(group);
		}
