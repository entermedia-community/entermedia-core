...
/**
 * Implementation of the <code>PropertyContainer</code> interface that retains a map of properties
 * in memory.
 * 
 * <p>
...
public class MapPropertyContainer extends ValuesMap
{
	...
	/**
	 * Determine whether the given name is valid. In order to be a valid name, the first character must
	 * be a letter or underscore, and each subsequent character must be a letter, digit, underscore, or
	 * period.
	 *
