...
public class Translation
{
	...
	public List webTranslateProperties(Map inProperties, String inLocale)
	{
		for (Iterator iter = inProperties.keySet().iterator(); iter.hasNext();)
		{
			...
			if ((name.startsWith(PREFIX) || name.equals("title")) && property.getValues().get(inLocale) == null)
			{
	...
	// This method takes a map of page properties and returns a list containing
	// triples of:
