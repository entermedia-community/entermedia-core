 ...
 */
package org.openedit.modules.reflect;
 ...
 * 
 *         Could make this an immutable object and eliminate the WebPageContext argument to the
 *         public methods.
 */
public class Reflector extends BaseModule
{
	...
	protected void invokeMethod(WebPageRequest inContext, Method method, Object sessionObject) throws Exception
	{
		...
		catch (InvocationTargetException ite)
		{
			...
			/*
			 * else if (throwable instanceof Message) { throw (Message) throwable; }
			 */
			else
								...
								if (parameterType.equals(long.class))
								{
									...
									if (parameterType.equals(double.class))
									{
										...
										if (parameterType.equals(byte.class))
										{
											...
											if (parameterTypes.equals(boolean.class))
											{
