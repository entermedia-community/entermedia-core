...
public class HtmlToXconfReader {
	...
	protected void saveProperties(WebPageRequest inReq, XconfConfiguration inConfig) {
		...
		// if( one.startsWith("property") && two.startsWith("property") &&
		// one.endsWith(".name") && two.endsWith(".name"))
		// {
		...
		// Now loop over new properties looking for any properties that start with
		// newprop..
