...
public interface PageRequestKeys
{
	...
	/**
	 * The servlet context path, e.g. if the root of an Open Edit site is at http://mydomain.org/oesite,
	 * the "home" variable will contain the String "oesite".
	 * 
	...
	/**
	 * This is a relative chunk of the URL path used to help locate relative resources. If a resource is
	 * located at http://mydomain.org/oesite/foo/index.html, the urlpath variable will contain the
	 * String "oesite/foo" so that we can easily find, for instance, oesite/foo/navbar.html
	 * 
	 * Use "$urlpath" in the Velocity page.
	 */
	public static final String URL_PATH = "urlpath";
	/**
	 * This is a relative chunk of the filepath used to help locate relative resources within a Velocity
	 * page. for a url of /content/about/about.html -> /content/about
	 * 
	...
	/**
	 * This is a Browser object, created from the request header that provides some convenience method
	 * for dealing with different browser types and OSes when different behavior is required.
	 * 
	...
	/**
	 * A DynamicPage object representing the current page. Page properties can be accessed by the "get"
	...
	/**
	 * This nifty class instantiation tool is something we found on the Velocity mailing list. It is
	 * used for instantiating new classes within a Velocity page.
	 * 
	...
	/**
	 * A PageStreamer object which allows dynamic pages to make a callback to the OpenEditEngine in
	 * order tor stream in content from other pages.
	 * 
	 * Use "$page" in the Velocity page.
	 */
	...
	/**
	 * Allows an action to specify an alternative inner layout. This applies to all inner pages NOLAYOUT
	 * is a valid value
	 */
