...
/**
 * <p>
 * Interface for a map to determine the MIME type for a file or path based upon its extension. This
 * interface was extracted from the class of the same name originally from JPublish
 * (http://www.jpublish.org) and adapted by Open Edit (http://www.openedit.org).
 * </p>
 * 
