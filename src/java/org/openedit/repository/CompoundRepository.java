 ...
 * 
 *         This Repository implementation delegates to other repositories based on the requested
 *         path. Be sure to set a default Repository.
 */
public class CompoundRepository implements Repository
{
	...
	/**
	 * The ID is a combination of the path + filter. For example /stuff/*.pdf or /stuffnull or just
	 * /stuff
	 * 
	 * @param inId
	 * @return
