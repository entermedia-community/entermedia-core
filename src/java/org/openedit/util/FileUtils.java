...
public class FileUtils
{
	...
	/**
	 * Create a temporary directory with a unique name beginning with the given prefix.
	 * 
	 * @param inPrefix The prefix for the created directory
	 * 
	 * @return DOCME
	 * 
	 ...
	 * DOCME
	 * 
	 * @param inSource DOCME
	 * @param inDest DOCME
	 * @param inBuffer DOCME
	 * 
	 * @throws IOException DOCME
	 */
	...
	/**
	 * Does a move even if the directory already exist Also creates a directory for file to be moved
	 * into
	 * 
	 * @param inSource
	 * @param inDest
