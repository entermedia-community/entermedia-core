									...
									if (elemName.equals("permission"))
									{
										...
										if (elemName.equals("path"))
										{
											...
											if (elemName.equals("referer"))
											{
												...
												if (elemName.equals("pageproperty"))
												{
																...
																if (elemName.equals("dataproperty"))
																{
																	...
																	if (elemName.equals("userproperty"))
																	{
																		...
																		else
																		{
																			...
																			{
																				for (Iterator iterator = inFilter.getConfiguration().getAttributeNames().iterator(); iterator.hasNext();)
																				{
																			...
																			for (Iterator iterator = inFilter.getProperties().keySet().iterator(); iterator.hasNext();)
																			{
																				String key = (String) iterator.next();
