...
public class ExecutorManager implements Shutdownable
{
	...
	public class ScalingThreadPoolExecutor extends ThreadPoolExecutor
	{
		...
		public ScalingThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue, ThreadFactory threadFactory) {
	...
	static class DefaultThreadFactory implements ThreadFactory
	{
		...
		DefaultThreadFactory(String inPrefix) {
			...
			namePrefix = inPrefix + "pool-" + poolNumber.getAndIncrement() + "-thread-";
		}
