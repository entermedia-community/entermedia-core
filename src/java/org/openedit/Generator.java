...
{
	/**
	 * This method should retrieve the response from the context and write content to it based on the
	 * information in the page and its generator data (which will have come from this generator).
	 *
	 * @param inContext The context for the given page
	 * @param inGenConfig The generator's configuration for the given page
	 * @param inOutput The output stream to which to write output //FIXME
	 */
